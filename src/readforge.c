...
int read(uint8_t **plain_text, msg_enc_key_p enc_key, char *raw_ratchet_key, char *raw_msg, data_message_s *data_msg){
...
int forge(char **encoded_data_msg, uint8_t *new_txt_msg, data_message_s *data_msg,
